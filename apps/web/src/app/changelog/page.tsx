...
export const metadata: Metadata = {
	title: "Changelog - VisionAstra",
	description: "What's new in VisionAstra",
	openGraph: {
		title: "Changelog - VisionAstra",
		description:
			"Every update, improvement, and fix to VisionAstra - documented.",
		type: "website",
		images: [
			{
...
export default function ChangelogPage() {
	...
	return (
		<BasePage title="Changelog" description="See what's new in VisionAstra">
